  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div class="card-body" v-show="!(visible.indexOf(0) > -1)">
        <img src="/userguide/pegi.png" alt="Presentation Image" class="section-image">
    ...
    <div class="card">
      ...
      <div class="card-body" v-show="!(visible.indexOf(3) > -1)">
        <div>
          ...
          <img src="/userguide/swordman.png" alt="Swordman" class="class-image">
          <p>{{ $t('games.wr.classes.contentSwordman') }}</p>
        </div>
        <div>
          <h5 class="sub-title">Healeuse:</h5>
          <img src="/userguide/healeuse.png" alt="Healer" class="class-image">
          <p>{{ $t('games.wr.classes.contentHealer') }}</p>
        </div>
        <div>
          <h5 class="sub-title">Berserk:</h5>
          <img src="/userguide/Barbare.png" alt="Berserk" class="class-image">
          <p>{{ $t('games.wr.classes.contentBerserk') }}</p>
        </div>
        <div>
          <h5 class="sub-title">Wizard:</h5>
          <!-- <img src="/userguide/wizard.png" alt="Wizard" class="class-image"> -->
    ...
    <div class="card">
      ...
      <div class="card-body" v-show="!(visible.indexOf(4) > -1)">
        <!-- <img src="/userguide/map.png" alt="Maps Image" class="section-image"> -->
    ...
    <div class="card">
      ...
      <div class="card-body" v-show="!(visible.indexOf(5) > -1)">
        <!-- <img src="/userguide/objects.png" alt="Objects Image" class="section-image"> -->
    ...
    <div class="card">
      ...
      <div class="card-body" v-show="!(visible.indexOf(6) > -1)">
        <!-- <img src="/userguide/fight.png" alt="Fight Image" class="section-image"> -->
