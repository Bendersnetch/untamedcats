    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row game-text">
          ...
          <div class="col-3">
            <img class="image" src="/whiskers_rebellion/logo.png"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row game-text">
          ...
          <div class="col-3">
            <img class="image" src="/warriors_cats/Logo.webp"/>
          </div>
        </div>
      </div>
    </div>
...
<style>
  .wr-bg {
    background-image: url('/whiskers_rebellion/Whiskers_Rebellion_Map.png');
  ...
  .wc-bg {
    background-image: url('//warriors_cats/Game.webp');
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    background-attachment: fixed;
