    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row game-text">
          ...
          <div class="col-3">
            <img class="image" src="../workspace/public/whiskers_rebellion/logo.png"/>
          </div>
        </div>
      </div>
    </div>

    <!-- Warrior Cats: Clan Battles Section -->
    <div class="card">
      <div class="card-nav">
        <h3><NuxtLink class="link-title" to="/games/wc">Warrior Cats: Clan Battles (2025)</NuxtLink></h3>
      </div>
      <div class="card-body">
        <div class="wc-bg"></div>
        <div class="row game-text">
          ...
          <div class="col-3">
            <img class="image" src="../workspace/public/warriors_cats/Logo.webp"/>
          </div>
        </div>
      </div>
    </div>
...
<style>
  .wr-bg {
    background-image: url('../workspace/public/whiskers_rebellion/Whiskers_Rebellion_Map.png');
  ...
  .wc-bg {
    background-image: url('../workspace/public/warriors_cats/Game.webp');
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    background-attachment: fixed;
